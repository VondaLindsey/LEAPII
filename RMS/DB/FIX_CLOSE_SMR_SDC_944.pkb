CREATE OR REPLACE PACKAGE BODY RMS13.FIX_CLOSE_SMR_SDC_944 IS
-- Module Name: FIX_CLOSE_SMR_SDC_944
...
FUNCTION CREATE_CARTON(O_error_message IN OUT varchar2,
   ...
   L_program VARCHAR2(61) := 'FIX_CLOSE_SMR_SDC_944.CREATE_CARTON';
...
FUNCTION explode_buyer_pack_allocation (O_error_message IN OUT varchar2,
   ...
   L_program varchar2(61) := 'FIX_CLOSE_SMR_SDC_944.EXPLODE_BUYER_PACK_ALLOCATION';
...
RETURN BOOLEAN is
   ...
   L_program VARCHAR2(64) := 'FIX_CLOSE_SMR_SDC_944.MAKE_ITEM_LOC';
...
RETURN BOOLEAN IS
   ...
   L_program              VARCHAR2(64) := 'FIX_CLOSE_SMR_SDC_944.PUB_SHIPMENT';
   L_to_loc               NUMBER;
